...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/register", "/css/**","/images/**","/esami","/TipologiaEsami","TipologiaEsame/Tipologiaesami","/tipologiaesame/{id}","/TipologiaEsame").permitAll()
